    ...
    <div class="container position-relative">
        <div class="row justify-content-between align-items-md-center">
            ...
            <div class="col-md-12 col-lg-12 col-xl-6">
                <form action="" class="login-sign-form login_process">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <div class="d-flex align-items-center mt-1">
                            ...
                            <input type="text" class="form-control text-center p-2 ms-2">
                            <input type="text" class="form-control text-center p-2 ms-2">
                            <input type="text" class="form-control text-center p-2 ms-2">
                            <input type="text" class="form-control text-center p-2 ms-2">
                            <input type="text" class="form-control text-center p-2 ms-2">
                    ...
                    <button type="button" class="btn btn-primary text-uppercase w-100 mt-5">Login</button>

                    <div class="mt-5 text-center">
                        <p>Or</p>
                        <div class="text-center my-5">
                            <a href="#" class="google-account"><img src="{{asset('assets/user/image/google-icon.png')}}" class="img-fluid" alt="google"></a>
                        </div>
                        <p>Don't have an account? <a href="javascript:void(0);" class="sign-btn" id="sign-slide">Sign up</a></p>
                    </div>
                </form>

                <form action="" class="login-sign-form signup_process">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input type="text" id="mobile_code" class="form-control mt-1" placeholder="Phone Number" name="name">
                    </div>
