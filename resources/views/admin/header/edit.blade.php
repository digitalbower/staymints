    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-block">
                ...
                <li class="breadcrumb-item" aria-current="page">Edit Header</li>
                </ul>
            </div>
            </div>
            <h4 class="text-start mb-4">Edit Header</h4>
            ...
            <form action="{{ route('admin.headers.update',$header->id) }}" id="headerForm" method="POST">
            @csrf
            @method('PUT')
                <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control" id="name" name="name" value="{{$header->name }}">
                </div>
                <div class="mb-3">
